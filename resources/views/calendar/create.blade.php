        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{ route('calendar.store') }}" method="POST" >
                @csrf
                @method('POST')
                <div class="card-body">
                  ...
                  <label>Date and time of push up event:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="push_event" class="form-control datetimepicker-input" data-target="#reservationdate"/>
                ...
                <div class="form-group">
                  <label>Start data:</label>
                    <div class="input-group date" id="reservationdate_two" data-target-input="nearest">
                        <input name="start_data" type="text" class="form-control datetimepicker-input" data-target="#reservationdate_two"/>
                ...
                <div class="form-group">
                  <label>End data:</label>
                    <div class="input-group date" id="reservationdate_three" data-target-input="nearest">
                        <input name="end_data" type="text" class="form-control datetimepicker-input" data-target="#reservationdate_three"/>
